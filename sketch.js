...
function setup(){
   ...
   for(var i = 0; i <= 800; i = i + 80 ) {
    divisions.push(new divisionBar(i,650,10,300));
}
for(var k = 40; k <= 780; k= k+50) {
    plinkos.push(new Plinko(k,75));
}
for(var k = 70; k<= 760; k=k+50) {
...
function draw() {
  ...
  text(" 200 ", 720, 550);
    ...
    if ( gameState == "PLAY"){
        text("press anywhere on the screen ",50,120)
    }
    if ( gameState =="END") {
